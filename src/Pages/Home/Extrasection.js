...
const Extrasection = () => {
    return (
        <div className='mx-2 mt-4 shadow-2xl'>
            <footer className="footer p-10 text-base-content shadow">
                <div>
                ...
                <div>
                    ...
                    <div className="form-control w-80">
                        ...
                        <div className="relative">
                            ...
                            <button className="btn text-red-700 font-bold absolute top-0 right-0 rounded-l-none">Subscribe</button>
                        </div>
                    </div>
                </div>
            </footer>
